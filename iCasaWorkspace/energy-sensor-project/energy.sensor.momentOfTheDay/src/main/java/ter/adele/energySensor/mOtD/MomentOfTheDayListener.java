package ter.adele.energySensor.mOtD;

/**
 * The listener interface for receiving momentOfTheDay events. The class that is
 * interested in processing a momentOfTheDay event implements this interface,
 * and the object created with that class is registered with a component using
 * the MomentOfTheDayService <code>register<code> method. When
