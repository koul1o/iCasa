...
import ter.adele.energySensor.mOtD.MomentOfTheDayListener;
...
@Instantiate(name = "energySensor followMe")

// Use the handler command and declare the command as a command provider. The
// namespace is used to prevent name collision.
public class FollowMeImpl implements DeviceListener, FollowMeConfiguration, MomentOfTheDayListener {
	...
	public synchronized void momentOfTheDayHasChanged(MomentOfTheDay newMomentOfTheDay) {
		...
		case NIGHT:
			...
			break;
		default:
			throw new IllegalArgumentException("Illigal value: " + moment);
