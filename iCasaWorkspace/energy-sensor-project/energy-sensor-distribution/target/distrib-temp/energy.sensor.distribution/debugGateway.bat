...
:EXECUTE
    ...
    "%JAVA%" -cp "%CLASSPATH%" %JVM_ARGS% -Xdebug -Xrunjdwp:transport=dt_socket,address=8000,server=y,suspend=y -Dchameleon.home=%CHAMELEON_HOME% org.ow2.chameleon.core.Main --interactive %ARGS%
